...
public class SellController extends BaseController{
    ...
    public Map<String, Object> getSellByParams(String goodsName, String customerName, @RequestParam(value = "pageIndex", defaultValue = "1") Integer pageIndex){
        try{
            ...
            list =  goodsDao.findPageByFetchedHql("select pur from SellEntity pur where pur.goodsByGoodsId.name like ? " +
                    "and pur.customerByCustomerId.companyName like ? order by pur.sellTime desc",null,pageIndex,pageSize,new String[]{"%"+goodsName+"%","%"+ customerName +"%"});
    ...
    @ResponseBody
    public Map<String,Object> getChartData(String beginTime, String endTime,String goodsName){
        try {
