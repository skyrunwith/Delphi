...
function updateSellChart(list){
    ...
    var ctx = document.getElementById("mySellChart");//cavas
    ...
    $(list).each(function (i, item) {
        ...
        data1[i] = new Object();
        data1[i].label = item[0].goodName + '销售量';
        data1[i].fill = false;
        ...
        data1[i].pointBorderColor = borderColorStr[i % 6],
...
function updatePurchaseChartData(list,goosName){
    ...
    $(list).each(function (i, item) {
        ...
        //data1[i] = item.purchase;
        data1[i] = new Object();
        data1[i].label = item[0].goodName + '采购量';
        data1[i].fill = false;
        data1[i].lineTension = 0.1,
        data1[i].backgroundColor = backgrounColorStr[i % 6],
        data1[i].borderColor = borderColorStr[i % 6],
