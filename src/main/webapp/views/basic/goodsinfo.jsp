...
<div class="col-sm-1">
    <div class="list-group" style="margin-bottom: -1px">
        <a href="#" class="list-group-item active " style="border-bottom-left-radius: 0px;border-bottom-right-radius: 0px">
            分类
        </a>
    </div>
...
<div class="col-sm-11">
    <table class="table table-bordered table-hover" id="goodsTb">
        <thead>
        <tr>
            <td>商品名称</td><td>生产地址</td><td>规格</td><td>包装</td><td>单价</td><td>售价</td><td>备注</td>
            <td style="max-width: 20px;text-align: center"><input type="checkbox" id="goodsCheckAlls" onclick="goodsCheckAll(this)" /></td>
