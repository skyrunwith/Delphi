...
<table class="table table-bordered" id="categoryList">
  ...
  <tr>
    <td>名称</td><td>备注</td>
    <td style="max-width: 20px;text-align: center"><input type="checkbox" id="categoryCheckAll" onclick="categoryCheckAll(this)" /></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="addCategoryBtn" onclick="addOrUpdateCategory()">保存</button>
      </div>
    </div>
  </div>
</div>